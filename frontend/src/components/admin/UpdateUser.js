...
export default function UpdateUser () {
    ...
    const {  user:authUser } = useSelector( state => state.authState)//if admin try to change into user its error and it should not happend so this create and useded in line no:96 or 97
                    ...
                    <div className="wrapper my-5"> 
                        <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data'>
                            ...
                            <div className="form-group">
                                ...
                                {/*//if admin try to change into user its error and it should not happend so this create */}
