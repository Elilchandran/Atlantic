...
export default function UpdatePassword() {
    ...
    const { isUpdated, error } = useSelector(state => state.authState)//if password updated succussfull or not below code
    ...
    //if password updated succussfull or not below code (this code already in updateProfile)
    useEffect(() => {
        if(isUpdated) {
