...
export default function Cart() {
    ...
    const checkoutHandler = () =>{
        navigate('/login?redirect=shipping')//if not login redirecting the user to login 
    }
    ...
    return (
        <Fragment>
            {items.length===0 ? 
                <h2 className="mt-5">Your Cart is Empty</h2> : //{/*this tells cart items empty in /cart */}
                <Fragment>
                     <h2 className="mt-5">Your Cart: <b>{items.length} items</b></h2>{/*this tells cart:1 or items in /cart */}
                                    ...
                                    <div className="cart-item">
                                        <div className="row">
                                            ...
                                            <div className="col-5 col-lg-3">
                                                <Link to={`/product/${item.product}`}>{item.name}</Link>{/*takes to product page */}
                                            </div>
